...
#    Updated: 2017/04/14 15:17:52 by thou             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_DIR		=	src/
SRC_BASE	=	fractol.c image.c info.c key.c color.c mouse.c
SRC_BASE	+=	mandelbrot.c julia.c julia4.c
SRC_BASE	+=	mandel3.c mandel5.c multibrot.c quinticorn.c tricorn.c
